...
class SearchForm(QWidget):
    def __init__(self, port=GUIPORT, ip=GUIIP):
        ...
        self.setWindowTitle('Traifix - User Interface')
        ...
        self.make_lable('Дата', 60, 0, 61, 41, True, 12)
        self.make_lable('От', 10, 40, 41, 21, True, 10)
        self.make_lable('До', 10, 70, 41, 21, True, 10)

        self.make_lable('Время', 250, 0, 61, 41, True, 12)
        self.make_lable('От', 190, 40, 41, 21, True, 10)
        self.make_lable('До', 190, 70, 41, 21, True, 10)

        self.make_lable('Локация', 430, 0, 71, 41, True, 12)
        self.make_lable('Город', 370, 40, 41, 21, True, 10)
        self.make_lable('Улица', 370, 70, 50, 21, True, 10)

        self.startDate = QDateEdit(self)
        self.startDate.move(50, 40)
        self.startDate.resize(110, 22)
        self.startDate.setDate(QDate.fromString('01/01/2023', "dd/MM/yyyy"))
        self.endDate = QDateEdit(self)
        self.endDate.move(50, 70)
        self.endDate.resize(110, 22)
        self.endDate.setDate(QDate.fromString('01/12/2023', "dd/MM/yyyy"))
    ...
    def appendToList(self, ID=3, Image=None, Date='a', Time='d', City='f', Location='g', startFrame=1, list=True):
        ...
        font.setBold(True)
        info.setFont(font)
        info.setText('   Camera Id: ' + str(ID) + '  Дата: ' + str(Date) + '    Город: ' + str(City)
